const Paciente = ({ paciente, setPaciente, eliminarPaciente }) => {
    ...
    return (
        <div className="mx-5 my-10 m-3 bg-white shadow-md px-5 py-10 rounded-md">
            ...
            <p className="font-bold mb-3 text-gray-700 uppercase text-justify">Síntomas: <span className="font-normal normal-case">{sintomas}</span></p>
            <div className="flex justify-between mt-10">
                <button type="button" className="py-2 px-10 bg-indigo-600 hover:bg-indigo-700 text-white uppercase font-bold rounded-md" onClick={() => {
                    setPaciente(paciente)
                }}>
                    Editar
                </button>
                <button type="button" className="py-2 px-10 bg-red-600 hover:bg-red-700 text-white uppercase font-bold rounded-md" onClick={handleEliminar}>
                    Eliminar
                </button>
            </div>
        </div>
